...
<div id="wrapper">
	...
	<table border="1" align="center" width="1000" id="seat" color="#fff2e6">
		...
		<th style="text-align:center; background-color:#90EE90"><font color="white">Concert Name</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Date</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Start</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">End</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Artist List</font></th>
...
<?php
	...
	while($row = mysql_fetch_assoc($result))
	{
        Print '<tr align="center" color="#fff2e6">
                  ...
                  <td height="60">'.$row['coid'].'</td>
                  <td>'.$row['name'].'</td>
				  <td>'.$row['date'].'</td>
				  <td>'.$row['start_time'].'</td>
				  <td>'.$row['end_time'].'</td>
				  <td width="80"><a href="viewartist1.php?coid='.$row['coid'].'"><img src="images/receipt1.png" width="40" height="40"></a></td>
				  <td width="80"><a href="editconcert.php?coid='.$row['coid'].'"><img src="images/edit.jpg" width="23" height="23"></a></td>
                  <td width="80"><a href="deleteconcert.php?coid='.$row['coid'].'"><img src="images/delete.jpg" width="23" height="23"></a></td>
				</tr>';	
				$count=$count+1;
	}
