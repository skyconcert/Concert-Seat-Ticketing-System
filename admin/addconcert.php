...
<div id="wrapper">
 	...
 	<div class="grid-form" >
 		...
 		<form name="form1" method="POST" action="addconcert_php.php" onSubmit="return editFunction()">

		  <div class="form-group">
			<label>ID</label>
			<input type="text" class="form-control1" placeholder="ID" id="coid" name="coid"  required="">
		  </div>
		   ...
		   <div class="form-group">
			<label for="aid">Start time</label>
			<input type="time" class="form-control1" id="start_time" name="start_time" required="">
		  </div>
		  
		  <div class="form-group">
			<label for="aid">End time</label>
			<input type="time" class="form-control1" id="end_time" name="end_time" required="">
		  </div>
