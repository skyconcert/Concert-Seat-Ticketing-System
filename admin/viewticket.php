...
<div id="wrapper">
			  ...
			  <form class=" navbar-left-right">
			   <form action="allcategory.php" method="post" name="search" class="search-wrap">
			               <div class="form-group">
			                 <td> <input type="text" id="myInput" onkeyup="myFunction()" class="form-control search" placeholder="Search by Ticket ID">
			                 <script>
								function myFunction() 
								{
	...
	<table border="1" align="center" width="900" id="admin" color="#fff2e6">
		<tr>
		<th height="50" style="text-align:center; background-color:	#F08080"><font color="white">No</font></th>
		<th height="50" style="text-align:center; background-color:	#F08080"><font color="white">Ticket ID</font></th>
		<th height="50" style="text-align:center; background-color:	#F08080"><font color="white">Book ID</font></th>
		<th style="text-align:center; background-color:	#F08080"><font color="white">Concert ID</font></th>
		<th style="text-align:center; background-color:	#F08080"><font color="white">Seat Number</font></th>
		</tr>
<?php
	include "dbcon.php";
...
echo "&nbsp;";
echo"</br>'";
echo"<h5 align='center'><b>Total Ticket : $totalconcert </b></h5>";
?>
</div>
<br>
 	<!--//grid-->
