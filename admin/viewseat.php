...
<div id="wrapper">
			  ...
			  <form class=" navbar-left-right">
			   <form action="allcategory.php" method="post" name="search" class="search-wrap">
			               <div class="form-group">
			                 <td> <input type="text" id="myInput" onkeyup="myFunction()" class="form-control search" placeholder="Search by Seat No">
			                 <script>
								function myFunction() 
								{
	...
	<table border="1" align="center" width="1000" id="seat" color="#fff2e6">
		...
		<th height="50" style="text-align:center; background-color:	#90EE90"><font color="white">Seat Number</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Row Number</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Category</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Price Seat</font></th>
		<th style="text-align:center; background-color:#90EE90"><font color="white">Entrance hall</font></th>
...
<?php
	...
	while($row = mysql_fetch_assoc($result))
	{
        Print '<tr align="center" color="#fff2e6">
                  ...
                  <td height="60">'.$row['seat_no'].'</td>
                  <td>'.$row['row_num'].'</td>
				  <td>'.$row['category'].'</td>
				  <td>'.$row['price_seat'].'</td>
				  <td>'.$row['entrance_hall'].'</td>
				  <td width="80"><a href="editseat.php?seat_no='.$row['seat_no'].'"><img src="images/edit.jpg" width="23" height="23"></a></td>
                  <td width="80"><a href="deleteseat.php?seat_no='.$row['seat_no'].'"><img src="images/delete.jpg" width="23" height="23"></a></td>
				</tr>';	
				$count=$count+1;
	}
$totalconcert=$count-1;
echo "</table>";
echo "&nbsp;";
echo"</br>'";
echo"<h5 align='center'><b>Total Concert : $totalconcert </b></h5>";
?>
</div>
<br>
 	<!--//grid-->
