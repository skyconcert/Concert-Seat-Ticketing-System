...
<?php
		 include "dbcon.php";
		 $coid = $_GET['coid'];	
		 $query = "SELECT * FROM concert WHERE coid='$coid'";
...
<div id="wrapper">
 	...
 	<div class="grid-form" >
 		...
 		<h3 id="forms-example" class="" align="center" >Update Concert<img src="images/edit2.png" alt="ADMIN" class="ADMIN" width="140" height="140"></h3>
 		<form action="editconcert_php.php?coid=<?php echo $coid;?>" method="post" name="form1" onSubmit="return editFunction()">

		  <div class="form-group">
			<label>Concert Name</label>
			<input type="text" class="form-control1" id="name" name="name" value='<?=$results['name'];?>'>
		  </div>
		  
		  		  
		    <div class="form-group">
			<label>Date</label>
			<input type="date" class="form-control1" id="date" name="date" value='<?=$results['date'];?>'>
		  </div>
		  

		   <div class="form-group">
			<label>Start Time</label>
			<input type="time" class="form-control1" id="start_time" name="start_time" value='<?=$results['start_time'];?>'>
		  </div>
		  
		   <div class="form-group">
			<label>End Time</label>
			<input type="time" class="form-control" name="end_time" id="end_time" value='<?=$results['end_time'];?>' required>
		  </div>
