...
<html>
<head>
<title>Information Admin and Staff</title>
...
<div id="wrapper">
 	...
 	<!--banner-->	
		   <div class="banner">
				...
				<span>Details admin and staff</span>
				</h2>
		    </div>
		<!--//banner-->
	...
	<form name="form1" onSubmit="return deleteFunction()">
	<table border="1" align="center" width="1000" id="admin">
		<tr>
		<th height="50" style="text-align:center; background-color:#FFB6C1"><font color="white">ID</font></th>
		<th style="text-align:center; background-color:#FFB6C1"><font color="white">Name</font></th>
		<th style="text-align:center; background-color:#FFB6C1"><font color="white">Password</font></th>
		<th style="text-align:center; background-color:#FFB6C1"><font color="white">Phone</font></th>
		<th style="text-align:center; background-color:#FFB6C1"><font color="white">Userlevel</font></th>
		<th style="text-align:center; background-color:#FFB6C1"><font color="white">Delete</font></th>
		</tr>
<?php
	include "dbcon.php";
	$sql = "SELECT aid, name, password, phone, userlevel FROM admin";
	$count=1;
	...
	while($row = mysql_fetch_assoc($result))
	{
        Print '<tr align="center" color="#fff2e6">
				  ...
				  <td>'.$row['phone'].'</td>
				  <td>'.$row['userlevel'].'</td>
                  <td><a href="delete-dataAdmin.php?aid='.$row['aid'].'"><img src="images/delete.jpg" width="25" height="25" onSubmit="return deleteFunction()"/></a></td>
				</tr>';	
				$count=$count+1;
	}
$totaladmin=$count-1;
...
echo "&nbsp;";
echo"</br>'";
echo"<h5 align='center'><b>Total Staff and Admin: $totaladmin </b></h5>";
?>
</div>
<br>
 	<!--//grid-->
