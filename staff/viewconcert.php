...
<div id="wrapper">
	...
	<table border="1" align="center" width="1000" id="admin" color="#fff2e6">
		<tr>
		<th height="50" style="text-align:center; background-color:	#DB7093"><font color="white">No</font></th>
		<th height="50" style="text-align:center; background-color:	#DB7093"><font color="white">Concert ID</font></th>
		<th style="text-align:center; background-color:	#DB7093"><font color="white">Name</font></th>
		<th style="text-align:center; background-color:	#DB7093"><font color="white">Date</font></th>
		<th style="text-align:center; background-color:	#DB7093"><font color="white">Start Time</font></th>
		<th style="text-align:center; background-color:	#DB7093"><font color="white">End Time</font></th>
		</tr>
<?php
	include "dbcon.php";
