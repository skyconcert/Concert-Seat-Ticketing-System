	...
	<head>
      ...
      <div class="card card-register mx-auto mt-4">
        ...
        <div class="card-body">
			...
			if($add) 
			{
				echo "<script type= 'text/javascript'>alert('Details succesfully added!');</script>";
			} else {
				echo "<script type= 'text/javascript'>alert('Error: " . $add . "<br>" .mysql_error()."');</script>";
		...
		session_destroy();
		echo'<html><script>window.location="contBook.php?id='.$totalCust.'";</script></html>';
